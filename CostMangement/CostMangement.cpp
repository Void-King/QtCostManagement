...
CostMangement::CostMangement(QWidget *parent)
    : QMainWindow(parent)
{
	ui.setupUi(this);
...
CostMangement::~CostMangement()
{

}

void CostMangement::eatFilterInit()
{
...
void CostMangement::uiConfig()
{
	QIcon wIcon("./resource/CostMangement.png");
...
bool CostMangement::CheckExit()
{
	return m_directExit;
}

void CostMangement::closeEvent(QCloseEvent *e)
{
	if (m_directExit)
	{
		e->accept();
...
void CostMangement::eventConnect()
{
...
void CostMangement::keyPressEvent(QKeyEvent* e)
{
	switch (e->key())
	{
	case Qt::Key_Return:
...
void CostMangement::costDataInitFromPython()
{
...
void CostMangement::costAnalyze(int& rowID, QDateTime& date,
...
void CostMangement::curRemain(double& cost)
{
...
bool CostMangement::weekCost(QDateTime& date, double& cost)
{
	bool check = false;
...
void CostMangement::weekEat(double& cost, QString& description)
{
	bool check = false;
...
bool CostMangement::monthCost(QDateTime& date, double cost)
{
	bool check = false;
...
bool CostMangement::monthEat(double cost, QString& description)
{
	bool check = false;
...
void CostMangement::monthOther(double cost)
{
...
void CostMangement::fileOpenError()
{
	QMessageBox tips;
	tips.setText("\n 提示：\n\n 文件读取错误！\t\n");
...
void CostMangement::costDataInit()
{
#ifdef _DEBUG
...
//void CostMangement::mouseDoubleClickEvent(QMouseEvent* e)
//{
...
//}
//
//void CostMangement::mousePressEvent(QMouseEvent* e)
//{//仅对鼠标左键响应，右键留着使用菜单功能
//	int wWidth = this->width();
//	int wHeight = this->height();
//	int wX = this->x();
...
//	}
//}
//void CostMangement::mouseMoveEvent(QMouseEvent* e)
//{//仅对鼠标左键响应，右键留着使用菜单功能
//	int wWidth = this->width();
//	int wHeight = this->height();
//	if (moveFlag)
...
void CostMangement::moveEvent(QMoveEvent* e)
{
	return;
}

void CostMangement::resizeEvent(QResizeEvent* e)
{
	int wWidth = this->width();
	int wHeight = this->height();
	int wX = this->x();
...
void CostMangement::ClickButtonExit()
{
	this->close();
}

void CostMangement::ClickButtonMinimize()
{
	this->showMinimized();
}

void CostMangement::ClickButtonAdd()
{
...
void CostMangement::getSelectionRowsAndCols(
...
void CostMangement::ClickButtonDelete()
{
...
void CostMangement::ClickButtonFolder()
{
	QString fileName = QDir::currentPath();
	// QString fileNameSec = QCoreApplication::applicationDirPath();
	// explorer.exe E:\qt\pythonToQt\CostMangement\CostMangement
	QProcess p;
